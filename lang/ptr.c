...
void ptr_basics(){
    ...
    *b = 20;
    ...
    //but when deref is used we need to 
    void* c = &a;
    ...
    *(int*)c = 30;
    ...
    //best use:
    //so think as i have 4 memories at 4 different location i.e. they do not come 1 after other
    //for e.g. memory location is as = 10 50 100 200
    //we can still make them using ** pointer to be together as arrays of pointer
    //int* a[] = {&10,&50,&100,&200}
    int e = 10;
    int f = 50;
    int g = 100;
