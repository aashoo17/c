...
/*
bit fields:
bit field can be used like enum say we want a value vary from 0 to 10 we need
atleast 4 bits so we can take atleast char type and set to use its 4 bits
*/
